    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                @endif " aria-current="page" href="#">Acceuil</a></li>
                <li class="nav-item @if(Route::has('admin')) active border @endif "><a class="nav-link" href="{{route('admin.produit.index')}}">Produit</a></li>
                <li class="nav-item"><a class="nav-link" href="#">Ventes</a></li>
                <li class="nav-item"><a class="nav-link" href="#">Entrees</a></li>
